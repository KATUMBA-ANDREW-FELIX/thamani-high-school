...
<head>
    ...
    <title>THAMANI HIGH SCHOOL - Kakiri | Excellence in Every Endeavor</title>
        ...
        <section id="page-home">
            ...
            <div class="relative h-[600px] flex items-center justify-center text-white overflow-hidden bg-brand-darkGreen">
                ...
                <div class="relative z-10 max-w-4xl mx-auto text-center px-4">
                    ...
                    <p class="text-lg md:text-2xl mb-8 text-gray-200 max-w-3xl mx-auto font-light">Welcome to Thamani High School, where we nurture the leaders of tomorrow with Ugandan values and global standards.</p>
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between items-end mb-12">
                        <div>
                            ...
                            <p class="text-gray-600">Stay updated with the latest happenings at Thamani High School.</p>
                        </div>
